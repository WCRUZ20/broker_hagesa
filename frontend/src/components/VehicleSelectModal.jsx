        ...
        <div className="modal-content-custom">
          <div className="modal-header-custom">
            <div className="header-content">
              <div className="title-section">
                <h2 className="modal-title-custom">Seleccionar Vehículo</h2>
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
          ...
          >
            <div className="form-group-modern" style={{ marginBottom: "1.5rem" }}>
              <input
                ...
                autoFocus
              />
              <label className="form-label-modern">Buscar vehículo</label>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((v, index) => (
                    ...
                    >
                      ...
                      <div style={{ opacity: 0.9 }}>{v.YearItem}</div>
                    </div>
                  ))
                )}
              </div>
          ...
          >
            ...
            >
              ...
              Haga clic en un vehículo para seleccionarlo
            </div>
            <button
              type="button"
