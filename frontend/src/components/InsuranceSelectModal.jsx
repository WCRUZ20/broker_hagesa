        ...
        <div className="modal-content-custom">
          <div className="modal-header-custom">
            <div className="header-content">
              <div className="title-section">
                <h2 className="modal-title-custom">Seleccionar Aseguradora</h2>
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  ...
                  {filtered.length} aseguradora{filtered.length !== 1 ? "s" : ""} encontrada{filtered.length !== 1 ? "s" : ""}
                </div>
              </div>
          ...
          >
            <div className="form-group-modern" style={{ marginBottom: "1.5rem" }}>
              <input
                ...
                autoFocus
              />
              <label className="form-label-modern">Buscar aseguradora</label>
              ...
              >
                {filtered.length === 0 ? (
                  ...
                  filtered.map((i, index) => (
                    <div
                      key={i.id}
                      onClick={() => handleInsuranceSelect(i)}
                      style={{
                        display: "grid",
                        gridTemplateColumns: "1fr 1fr",
                        gap: "1rem",
                    ...
                    >
                      ...
                      <div style={{ fontWeight: "500" }}>{i.CompanyName}</div>
                    </div>
                  ))
                )}
              </div>
          ...
          >
            ...
            >
              ...
              Haga clic en una aseguradora para seleccionarla
            </div>
            <button
              type="button"
