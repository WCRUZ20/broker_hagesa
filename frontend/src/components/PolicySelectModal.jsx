        ...
        <div className="modal-content-custom">
          <div className="modal-header-custom">
            <div className="header-content">
              <div className="title-section">
                <h2 className="modal-title-custom">Seleccionar Póliza</h2>
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  ...
                  {filtered.length} póliza{filtered.length !== 1 ? "s" : ""} encontrada{filtered.length !== 1 ? "s" : ""}
                </div>
              </div>
          ...
          >
            <div className="form-group-modern" style={{ marginBottom: "1.5rem" }}>
              <input
                ...
                autoFocus
              />
              <label className="form-label-modern">Buscar póliza</label>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((p, index) => (
                    ...
                    >
                      ...
                      <div style={{ fontWeight: "500" }}>{p.DocType}</div>
                    </div>
                  ))
                )}
              </div>
          ...
          >
            ...
            >
              ...
              Haga clic en una póliza para seleccionarla
            </div>
            <button
              type="button"
