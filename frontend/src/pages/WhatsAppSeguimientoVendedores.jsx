...
export default function WhatsAppSeguimientoVendedores() {
  ...
  const sendMessages = async () => {
    ...
    try {
      await API.post("/seguimiento/historial-whatsapp/enviar-vendedores", {
        policy_ids: selected,
      });
      setSelected([]);
    ...
    <div className="container-fluid py-4">
      ...
      <div className="row">
        ...
        <div className="col-md-6 mb-4">
          <div className={`card border-0 shadow-sm ${darkMode ? "bg-dark" : "bg-white"}`}>
            <div className="card-body">
              <h5 style={{ color: "white" }}>Mensajes enviados</h5>
              <div className="mb-3">
                <input
                  type="text"
